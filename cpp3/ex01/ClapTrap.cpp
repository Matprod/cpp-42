...
/*   Updated: 2025/03/13 14:06:21 by Matprod          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount){
	if (this->_energy_point > 0)
	{
		if (this->_energy_point + (int)amount >= CLAP_HIT_POINT)
		{
			...
			cout << "\033[0;32mClapTrap : \033[1;32m" << this->_name << "\033[0;m \033[1;34 mrepaired himself with magic\033[0;m and has gain \033[1;31m" << amount << "\033[0;m hit points" << std::endl;
			cout << "\033[0;32mClapTrap : \033[1;32m" << this->_name << "\033[0;m has now \033[1;31m" << this->_hit_point << "\033[0;m hit points !" << std::endl;
		}
		else
		{
